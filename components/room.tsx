...
//                   </span>
//                   <span className="flex  gap-3 my-5">
//                     <Image src="/links.png" alt="" width={20} height={20} className="object-contain" />
//                     <p>
...
//           <hr className="mt-4 mb-4 border-blue-900" />
//           <div className="">
//             <h1 className="font-bold mb-4">What this Place has to Offers</h1>
//             <div className="flex items-center gap-4 sm:gap-14 mb-6 bg-slte-300 flex-col sm:flex-row self-start sm:self-start">
...
//                 </p>
//                 <p className="flex gap-4">
//                   <Image src="/house.png" alt="" width={20} height={20} className="object-contain" />
